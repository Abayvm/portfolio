        ...
        <>
            ...
            <div className="blog-body">
                ...
                <p>
                    ...
                    from goDaddy and made this website using React.js. Hosted it on <i>vercel</i>. You can check the code out here on <i><a href="https://github.com/Abayvm/portfolio" target="_blank">github</a></i>.
                    <br/>I still have no idea how my code works.<br /> 
